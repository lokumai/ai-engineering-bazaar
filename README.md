...
| [NOT READY] [Expert](mini-courses/3_expert/README.md)                     | 16-25   | Advanced UI, architectures, tools, memory, multi-agent, prompting, context engineering, harness engineering, deployment, training.  |
| [NOT READY] [Ecosystem](mini-courses/4_ecosystem/README.md)               | 26-31   | Agent frameworks, inference providers, inference engines, UI design, observability, choosing a tech stack.                                       |
| [NOT READY] [Protocols & Specs](mini-courses/5_protocols_specs/README.md) | 32      | A single reference of every protocol and spec mentioned across the series.                                                |
| [NOT READY] [Optional](mini-courses/6_optional/README.md)                 | 33-34   | Human-in-the-loop and runtime topics that round out the series.                                                           |
