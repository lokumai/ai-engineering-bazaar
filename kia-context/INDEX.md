...
`M1…M15` are milestones in `logs/PROGRESS.md` and `M16` is in `logs/PROGRESS_2.md`. `D1…D25` are decisions in `logs/BRAINSTORM.md` and `D26…D53` are in `logs/BRAINSTORM_2.md`, where `O1…O4` are the open questions
