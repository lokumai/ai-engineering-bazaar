...
| Where can a number in a SENTENCE come from? | The corpus, counted at build time — **D65**, after `five to ten minutes a module` sat in three documents and one page, wrong by a factor of three, for the life of the project. A number from outside the repository is **D64** |
