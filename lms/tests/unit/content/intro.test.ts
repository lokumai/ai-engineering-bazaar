 ...
 * and the `[← Back to overview]` link, which addresses an MkDocs route the LMS
 * does not serve. Both are stripped here, at load time, in the pipeline —
 * `mini-courses/` is read-only and MkDocs still serves those files verbatim.
 */
