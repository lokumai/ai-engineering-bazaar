...
It is also the reason RAG works at all. In [Module 3](../1_fundamentals/3_rag.md) the weights never
...
[Module 13: Security](13_security.md).
...
> their schemas and descriptions ([Module 4](../1_fundamentals/4_tools.md)). If you want to see
...
is what [Module 7](../1_fundamentals/7_multi_agent.md) was quietly assuming when it drew a
