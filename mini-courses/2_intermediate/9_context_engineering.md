# Module 9: Context Engineering — Curating the Window, Turn by Turn
...
The honest rule: delegate **read-heavy, self-contained questions** ("investigate how token refresh works"). Keep **decisions** in the main thread. Orchestration topologies are [Module 13](13_loop_engineering.md)'s territory.
