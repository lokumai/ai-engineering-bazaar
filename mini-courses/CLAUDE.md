...
`kia-context/specs/ARCHITECTURE.md`, which covers the repository, the build and the application. It
used to be a file at the repository root; it was folded into the context harness on 2026-09-08.
