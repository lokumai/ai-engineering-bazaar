...
4. ⚜️ [ADVANCED] ⚜️ If you want to become a rare, highly-skilled AI engineer, take the [Expert](3_expert/README.md) course to learn advanced topics.
...
Because browser storage can be cleared without warning, **export is a real feature**. From the profile sheet you can write your whole record to a file, and the `RECORD OF WORK` is a single HTML file you keep, which works offline years later and can be imported into another browser.
