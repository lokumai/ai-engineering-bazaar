 ...
 * `/ai-engineering-bazaar/ai-engineering-bazaar/` and every internal link
 * 404s. `<Link>` takes the app-relative path as written.
 *
 * `NEXT_PUBLIC_SITE_BASE_PATH` is inlined by next.config.mjs at build time, so
